...
Write a Korean 정색 column: serious, sharp criticism of Korean society, economy, companies, labor, policy, regulation, or everyday cost burdens. Not satire, not neutral news.

Return only the requested JSON.

Rules:
- Korean only. Category exactly 정색.
- Use supplied editorial judgment as the spine.
- Criticize structures, incentives, hidden cost/risk/responsibility transfers, and missing people in official language.
...
- Who benefits?
- Who pays?
- What cost, inconvenience, risk, or responsibility moved?
- What question did normal coverage avoid?

Avoid:
- 향후 논란이 예상된다, 귀추가 주목된다, 투명성이 필요하다, 업계의 과제, 사회적 논의, 모두의 지혜, 신중한 접근, 균형 있는 접근.
